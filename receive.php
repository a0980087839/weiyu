<?php
  ...
  $imageId = $json_obj->events[0]->message->id; //取得訊息編號
	...
	curl_setopt($ch, CURLOPT_HTTPHEADER, array(
		'Authorization: Bearer zXq+0AN6U2Qg+vItWGLyzN3bxMrwD0b485KPzI00cPBGMPzmL/NTVuCSnLvxvwHXIOXzUFYmyUrVcs+TVempzKtQRXGIHzDkOsgqK4kjJXhjb4TyvwbbGhrYbFKGaHBSfzSsF3UHUh/YmYn3f+vD2gdB04t89/1O/w1cDnyilFU='
	));
	...
	$post_data = array (
		"requests" => array (
				array (
					"image" => array (
						"source" => array (
							"imageUri" => "http://139.59.123.8/chtChatBot/weiyu/".$imageId.".jpeg"
						)
					),
					"features" => array (
						array (
